...
const Support = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Lovepaws is a platform to connect owners. While we don't charge a platform fee, some current owners or shelters may request a rehoming fee to ensure the pet goes to a financially stable home. This is discussed directly between you and the owner.",
    },
    {
