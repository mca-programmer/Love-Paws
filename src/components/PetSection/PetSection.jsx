...
const PetSection = () => {
  const pets = [
    { name: "Cats", image: "https://i.postimg.cc/6qhKSjHn/ragdoll-cath5-Shutterstock-1.jpg" },
    { name: "Dogs", image: "https://i.postimg.cc/qRWFB8FX/istockphoto-474486193-612x612.jpg" },
    { name: "Rabbits", image: "https://i.postimg.cc/zGSYdPct/rabbit.png" },
    { name: "Hamsters", image: "https://i.postimg.cc/m2j0CF1Z/hamster.avif" },
    { name: "Birds", image: "https://i.postimg.cc/VvdbgtsT/bird.jpg" },
    { name: "Guinea Pig", image: "https://i.postimg.cc/9QMQs76X/guinea-pig.png" },
  ];

  return (
    <section className="bg-[#111] py-16 text-center text-white overflow-hidden ">
        ...
        <div className="relative w-full overflow-hidden ">
          <div className="flex gap-6 whitespace-nowrap marquee">
            {[...pets, ...pets].map((pet, index) => (
              <div
                key={index}
                className="min-w-[220px] bg-[#1b1b1b] rounded-xl p-10 
